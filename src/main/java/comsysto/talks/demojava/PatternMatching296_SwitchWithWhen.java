...
//      case IntegerHolder(var i) when i < 10 -> "small";
//      case Integer i when i < 1000 -> "medium";
//      case IntegerHolder(var i) when i < 10 -> "medium";
//      case Integer i when i < 100000 -> "big";
//      case IntegerHolder(var i) when i < 10 -> "big";
